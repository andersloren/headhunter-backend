...
//public class DBDataInitializer {
    ...
    public DBDataInitializer(UserService userService, JdbcTemplate jdbcTemplate, JobRepository jobRepository, JobService jobService) {
...
//                "    <header id=\"header\">\n" +
//                "        <div class=\"container\">\n" +
//                "            <h1>Jobbannons - Tester av Programvarufunktioner</h1>\n" +
//                "        </div>\n" +
//                "    </header>\n" +
//                "\n" +
//                "    <section id=\"content\">\n" +
...
//                "            <h2>Om tjänsten</h2>\n" +
//                "            <p>\n" +
//                "                Vi letar efter en motiverad och ansvarsfull person att ansluta till vårt team som en testare för programvarufunktioner. Din huvudsakliga uppgift kommer att vara att tester våra nyutvecklade funktioner och se till att de uppfyller våra höga standarder.\n" +
//                "            </p>\n" +
//                "\n" +
//                "            <h2>Dina uppgifter</h2>\n" +
//                "            <ul>\n" +
//                "                <li>Utföra systematiska tester av våra produkter och diagnostisera fel eller problem</li>\n" +
//                "                <li>Skapa detaljerade rapporter om testresultaten</li>\n" +
//                "                <li>Samarbeta med vårt utvecklingsteam för att korrigera eventuella brister</li>\n" +
//                "            </ul>\n" +
//                "\n" +
//                "            <h2>Kvalifikationer</h2>\n" +
//                "            <ul>\n" +
//                "                <li>Utmärkt teknisk förmåga</li>\n" +
//                "                <li>Uthållig och driven</li>\n" +
//                "                <li>Förmåga att arbeta självständigt och hålla deadlines</li>\n" +
//                "            </ul>\n" +
//                "\n" +
//                "            <h2>Så här ansöker du</h2>\n" +
//                "            <p>Skicka in ditt CV och personligt brev till oss senast den XXe månaden 20XX.</p>\n" +
//                "        </div>\n" +
//                "    </section>\n" +
//                "\n" +
//                "    <footer id=\"footer\">\n" +
//                "        <p>&copy; 2022 Vårt Företag</p>\n" +
//                "    </footer>\n" +
//                "</body>\n" +
//                "</html>");
//
