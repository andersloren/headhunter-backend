...
public class AccountService implements UserDetailsService {
    ...
    public Account save(Account account) {
        if (account == null) throw new NullPointerException("Account object cannot be null");
    ...
    public Account register(AccountDtoFormRegister accountDtoFormRegister) {
        if (accountDtoFormRegister == null) throw new NullPointerException("Account object cannot be null");
     ...
     *
     * @param accountEmail Is used to find the Account object that we want to update.
     ...
     * @return AccountDetails Here are the credentials that are being matched with the provided username and password by the user when trying to log in.
     * @throws UsernameNotFoundException If the Account object doesn't exist, this exception is being thrown.
     */
