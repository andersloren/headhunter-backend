...
public class MySQLDatabaseInitializer implements CommandLineRunner {
    ...
    public MySQLDatabaseInitializer(AccountService accountService, JobService jobService, AdService adService) {
    ...
    public void run(String... args) throws Exception {
        ...
        admin.setEmail("admin-mysql@hh.se");
        admin.setPassword("a");
        admin.setRoles("admin");

        Account user1 = new Account();
        user1.setEmail("user1-mysql@hh.se");
        user1.setPassword("a");
        user1.setRoles("user");

        Account user2 = new Account();
        user2.setEmail("user2-mysql@hh.se");
        user2.setPassword("a");
        user2.setRoles("user");

        Account user3 = new Account();
        user3.setEmail("user3-mysql@hh.se");
        user3.setPassword("a");
        user3.setRoles("user");
        ...
        this.jobService.addJob("user1-mysql@hh.se", job1);
        this.jobService.addJob("user1-mysql@hh.se", job2);
        this.jobService.addJob("user2-mysql@hh.se", job3);
        this.jobService.addJob("user3-mysql@hh.se", job4);
