...
@Transactional
public class AccountControllerAuthorityIntegrationMySQLTest {
    ...
    void test_FindAll_AdminPermission_Success() throws Exception {
        this.mockMvc.perform(get(this.baseUrlAccount + "/findAll")
                ...
                .andExpect(jsonPath("$.data[0].email").value("admin-mysql@hh.se"))
                ...
                .andExpect(jsonPath("$.data[1].email").value("user1-mysql@hh.se"))
                ...
                .andExpect(jsonPath("$.data[2].email").value("user2-mysql@hh.se"))
                ...
                .andExpect(jsonPath("$.data[3].email").value("user3-mysql@hh.se"))
    ...
    void test_GetAccountDtoByEmail_Success() throws Exception {
        this.mockMvc.perform(get(this.baseUrlAccount + "/getAccountDtoByEmail" + "/user1-mysql@hh.se")
                        .accept(MediaType.APPLICATION_JSON)
                        .header(HttpHeaders.AUTHORIZATION, adminToken()))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
                .andExpect(jsonPath("$.message").value("Find One Account Success"))
                .andExpect(jsonPath("$.data.email").value("user1-mysql@hh.se"))
    ...
    void test_Register_UserPermission_Success() throws Exception {
        ...
        this.mockMvc.perform(get(this.baseUrlAccount + "/findAll")
                ...
                .andExpect(jsonPath("$.data[3].roles").value("user"))
                .andExpect(jsonPath("$.data[3].number_of_jobs").value(1))
                .andExpect(jsonPath("$.data[4].email").value("user4-mysql@hh.se"))
    ...
    void test_Update_AdminPermission_Success() throws Exception {
        ...
        this.mockMvc.perform(put(this.baseUrlAccount + "/update" + "/user1-mysql@hh.se")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json)
                        .accept(MediaType.APPLICATION_JSON)
                        .header(HttpHeaders.AUTHORIZATION, adminToken()))
    ...
    void test_Update_UserNoPermission_Exception() throws Exception {
        ...
        this.mockMvc.perform(put(this.baseUrlAccount + "/update" + "/admin-mysql@hh.se")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonRole)
                        .accept(MediaType.APPLICATION_JSON)
                        .header(HttpHeaders.AUTHORIZATION, userToken()))
        ...
        this.mockMvc.perform(get(this.baseUrlAccount + "/getAccountDtoByEmail" + "/admin-mysql@hh.se")
                        .accept(MediaType.APPLICATION_JSON)
                        .header(HttpHeaders.AUTHORIZATION, adminToken()))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
                .andExpect(jsonPath("$.message").value("Find One Account Success"))
                .andExpect(jsonPath("$.data.email").value("admin-mysql@hh.se"))
                .andExpect(jsonPath("$.data.roles").value("admin"));
    }
    ...
    void test_Delete_AdminPermission_Success() throws Exception {
        this.mockMvc.perform(delete(this.baseUrlAccount + "/delete" + "/user1-mysql@hh.se")
                        .accept(MediaType.APPLICATION_JSON)
                        .header(HttpHeaders.AUTHORIZATION, adminToken()))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
        ...
        this.mockMvc.perform(get(this.baseUrlAccount + "/findAll")
                ...
                .andExpect(jsonPath("$.data[0].roles").value("admin"))
                .andExpect(jsonPath("$.data[0].number_of_jobs").value(0))
                .andExpect(jsonPath("$.data[1].email").value("user2-mysql@hh.se"))
                .andExpect(jsonPath("$.data[1].password").isNotEmpty())
                .andExpect(jsonPath("$.data[1].roles").value("user"))
                .andExpect(jsonPath("$.data[2].number_of_jobs").value(1))
                .andExpect(jsonPath("$.data[2].email").value("user3-mysql@hh.se"))
                .andExpect(jsonPath("$.data[2].password").isNotEmpty())
                .andExpect(jsonPath("$.data[2].roles").value("user"))
                .andExpect(jsonPath("$.data[2].number_of_jobs").value(1));
    }
    ...
    void test_DeleteAccount_UserNoPermission_Exception() throws Exception {
        ...
        this.mockMvc.perform(delete(this.baseUrlAccount + "/delete" + "/admin-mysql@hh.se")
                        .accept(MediaType.APPLICATION_JSON)
                        .header(HttpHeaders.AUTHORIZATION, userToken()))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.FORBIDDEN))
