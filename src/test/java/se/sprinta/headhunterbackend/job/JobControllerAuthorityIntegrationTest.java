...
@Transactional
public class JobControllerAuthorityIntegrationTest {
    ...
    void test_FindAll_AdminPermission_Success() throws Exception {
        this.mockMvc.perform(get(this.baseUrlJob + "/findAll")
                ...
                .andExpect(jsonPath("$.data[2].instruction").value("job3 Instruction 3"))
                .andExpect(jsonPath("$.data[0].recruiterName").isEmpty())
                ...
                .andExpect(jsonPath("$.data[3].description").value(
                ...
                .andExpect(jsonPath("$.data[3].instruction").value(
